...
class World:
    ...
    wheelDims=(2/12, 3/12)
    eyeList=(localize.Eye( 0 ,0.415,-0.415,  90.0, SCAN_DATA_POINTS, SCAN_ANGLE, "CW"),
            localize.Eye(  1 ,-0.415,-0.415,  90.0, SCAN_DATA_POINTS, SCAN_ANGLE, "CCW"),
            localize.Eye(  2 ,-0.415,0.415,  270.0, SCAN_DATA_POINTS, SCAN_ANGLE, "CW"),
            localize.Eye(  3 ,0.415,0.415,  270, SCAN_DATA_POINTS, SCAN_ANGLE, "CCW"))
    robotSide = 1.0
